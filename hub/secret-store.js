...
const CONNECTOR_ACCOUNTS = Object.freeze({
  ...
  "email.1.refreshToken": "connector:email.1.refreshToken",
  "email.1.address": "connector:email.1.address",
  "email.2.refreshToken": "connector:email.2.refreshToken",
  "email.2.address": "connector:email.2.address",
  "email.3.refreshToken": "connector:email.3.refreshToken",
